         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-5 mt-5">
                  <div class="col-sm-6">
                        <h1 class="m-0 text-secondary"><span class="fa fa-user-tie"></span> List of Requested Lawyers for Approval</h1>
                  </div>
                  <!-- /.col -->
...
<!-- <table id="example" class="display" style="width:100%"> -->
        ...
        <tbody>
            ...
            <td><img width=50px height=50px src="<?php echo "./data/lawyer-image/" . $fet['profile_image']; ?> "/></td>
                ...
                <td class="text-right">
                <a class="btn btn-sm btn-success" href="./update-approve-lawyer.php?lawyerid=<?php echo $fet['lawyerid']; ?>"><i class="fa fa-edit"></i> Approve</a>
