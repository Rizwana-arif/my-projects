    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            ...
            <tr>
                ...
                <th>Action</th>
                        ...
                        <tbody>
                        <?php
        $sql="SELECT * FROM `appointment-rec` a INNER JOIN `lawyers-rec` l ON  a.lawyer_name=l.lawyerid INNER JOIN `case-type` c ON a.case_category=c.caseid where `statuss`='accept'";
       ...
       <tr>
           ...
           <td class="text-right">
                         ...
                         <a class="btn btn-sm btn-success" title="Pending" href="./update-appoin-unaccept.php?appoinid=<?php echo $fet['appoinid']; ?>"><i class="fa-solid fa-hourglass-half"></i></a>
