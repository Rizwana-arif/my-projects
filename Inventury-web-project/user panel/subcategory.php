			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-4 col-12">
						<div class="shop-sidebar">
								...
								<div class="single-widget category">
									...
									<ul class="categor-list">
										<?php 
										$subsql="SELECT * FROM `sub-category-rec` where `subid`=$getsubcat";
										$subrun=mysqli_query($conn,$subsql);
                                        $subfet=mysqli_fetch_assoc($subrun);
                                        $ccid=$subfet['catname'];
                                        $csql="SELECT * FROM `sub-category-rec` where `catname`='$ccid'";
                                        $crun=mysqli_query($conn,$csql);
										while($cfet=mysqli_fetch_assoc($crun)){
										?>
										<li><a href="./subcategory.php?subid=<?php echo $cfet['subid']; ?>">
									<?php echo $cfet['subname']; ?></a></li>
										<?php } ?>
									</ul>
								</div>
								<!--/ End Single Widget -->
					...
					<div class="col-lg-9 col-md-8 col-12">
						...
						<div class="row">
							<?php 
							$psql="SELECT * FROM `product-rec` WHERE `status`='online' and `psubctg`='$getsubcat'";
